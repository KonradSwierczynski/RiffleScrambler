...
public:
    ...
    HashElement(const char * const message, const size_t message_len, const MD_Wrapper);
...
HashElement::HashElement(const MD_Wrapper wrapper): wrapper{wrapper}, md(wrapper.get_size()) {
}

HashElement::HashElement(const char * const message, const size_t message_len, const MD_Wrapper wrapper): wrapper{wrapper} {
